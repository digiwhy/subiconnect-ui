...
- [#180](https://github.com/subifinancial/subi-connect/pull/180)
  [`b26ad40`](https://github.com/subifinancial/subi-connect/commit/b26ad406a9db0da34b0d9833736ebb62da5e8300)
  Thanks [@keeganpotgieter](https://github.com/keeganpotgieter)! - Enhance
  OAuth2 authentication flow and improve connection handling:
  ...
  3. Enhanced `waitForWindowClose` function:
     ...
     - Implemented `checkIntegrationSuccess` to check OAuth status before
       closing the window.
     - Improved cleanup process and error handling.
  4. Updated `handleOAuth2OnSuccess` function:
     - Added `connectionService` parameter and passed it to
       `waitForWindowClose`.
  ...
  These changes enhance the OAuth2 authentication process, improve connection
  handling, and provide better integration with the Subi Connect service.
